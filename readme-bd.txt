...
CREATE USER alin WITH ENCRYPTED PASSWORD 'alin';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO alin;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO alin;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO alin;